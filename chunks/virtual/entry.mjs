...
import { c as createError, l as hasProtocol, f as joinURL, m as defu, w as withQuery, s as sanitizeStatusCode, p as parseURL, e as encodePath, n as decodePath, o as isScriptProtocol, $ as $fetch } from '../nitro/nitro.mjs';
import { START_LOCATION, createMemoryHistory, createRouter, useRoute, RouterView } from 'vue-router';
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		name: "fetch",
		path: "/fetch",
		component: () => import('../build/fetch-D_H8VjGS.mjs')
	},
	{
		name: "id",
		path: "/:id()",
		component: () => import('../build/_id_-CydGZVFs.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-C5jwH8yX.mjs')
	}
];
//#endregion
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
	...
	_push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
		default: withCtx((_, _push, _parent, _scopeId) => {
			if (_push) {
				_push(`<div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10"${_scopeId}><div class="mx-auto max-w-3xl py-10 md:py-16"${_scopeId}>`);
				_push(ssrRenderComponent(_component_NuxtPage, null, null, _parent, _scopeId));
				_push(`</div></div>`);
			} else return [createVNode("div", { class: "mx-auto max-w-7xl px-5 sm:px-8 lg:px-10" }, [createVNode("div", { class: "mx-auto max-w-3xl py-10 md:py-16" }, [createVNode(_component_NuxtPage)])])];
		}),
		_: 1
	}, _parent));
}
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-BDkWd_kL.mjs'));
		const _Error = defineAsyncComponent(() => import('../build/error-500-DqNhAiyI.mjs'));
...
export { $fetch$1 as $, _plugin_vue_export_helper_default as _, useRoute$1 as a, appDiagnostics as b, useNuxtApp as c, asyncDataDefaults as d, docsBase as e, fetchDefaults as f, createError$1 as g, useHead$1 as h, useRouter as i, encodeRoutePath as j, nuxtLinkDefaults as k, entry as l, navigateTo as n, prodReporters as p, resolveRouteObject as r, sanitizeTag as s, useRuntimeConfig as u };
